...
repeatFolderTitle='Sample';
positionFolderTitle='hydrated';
...
for r=startRepeat:skipRepeat:endRepeat
    ...
    for p=startPosition:skipPosition:endPosition
        ...
        %
        % Use a zero reference A-Scan - the real one causes issues!
        %
        referenceAScan = zeros(size(referenceAScan));
        for b=1:numBScans
        ...
        minSAM=0;
        maxSAM=0.5;  % attenuation in pixel^-1
        
        minAD=0;
        maxAD=60;  % depth in pixels
